...
with pd.ExcelWriter('D:\SCADA Project\TELEMETRY FORMAT\output.xlsx') as writer:
    for ind2 in master.index:
        ...
        tempdf = tempdf[['S No','SystemTimeSec','StationID','Station Name','Key','Name','Point Type','Point Type Name','Quality' ]]
